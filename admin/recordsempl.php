    ...
    <form name='qqq' action="" method="post">
       <div class="color_for_form">
        <input type="date" name="date" value="<?php
                                                if(isset($_POST['date']))
                                                    echo $_POST['date'];
                                                else if(isset($_SESSION['post_empl']['date']))
                                                    echo $_SESSION['post_empl']['date'];
                                            ?>">
        <select name="empl" >
            <option value="<?php
                                if(isset($_POST['empl']))
                                    echo $_POST['empl'];
                                else if(isset($_SESSION['post_empl']['empl']))
                                    echo $_SESSION['post_empl']['empl'];
                            ...
                            {
                                $id_empl=antisql($connect,$_SESSION['post_empl']['empl']);
                                $fio=mysqli_fetch_assoc(mysqli_query($connect, "SELECT `fio` FROM `empl` WHERE `id`='$id_empl'"))['fio'];
                                echo $fio;
                            }
                            ?>
        ...
        <input type="submit" class="button_blue" value="Показать записи">
        </div>
    <br>
        <?php
            ...
            if(isset($_POST['chang'.$id]))
            {
                if($id_user==0&&$id_serv==0)
                {
                    ...
                    if($query)
                    {
                        ...
                        echo "<script>window.location.href='recordsempl.php';window.location.replace('recordsempl.php');</script>";
                        exit;
                    }
                    else
                    {
